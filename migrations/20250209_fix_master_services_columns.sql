-- Fix master_services table columns to ensure they exist
-- This migration ensures all required columns exist and refreshes the schema
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE public.master_services
      ADD COLUMN question_max_length integer DEFAULT 500 CHECK (question_max_length BETWEEN 50 AND 2000);
    
    -- Note: We can't reference question_min_length in the CHECK constraint directly
    -- The constraint will be validated at insert/update time
